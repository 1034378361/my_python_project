...
from my_python_project.utils.common import (
    ...
    # 字符串工具
    safe_filename, slugify, clean_text,
    # 文件工具
    ensure_dir, load_json, save_json, load_yaml, save_yaml, 
    load_pickle, save_pickle, get_file_size, list_files,
    # 数据工具
    deep_merge, flatten_dict, chunk_list, calculate_md5, calculate_sha256,
    get_date_range,
    # 验证工具
    is_valid_email, is_valid_url,
    # 其他工具
    generate_random_string, generate_uuid, retry_on_failure, timing_decorator
)
...
class TestStringUtils:
    ...
    def test_safe_filename(self):
        ...
        # 特殊字符替换
        assert safe_filename("file<>:\"|?*.txt") == "file________.txt"
