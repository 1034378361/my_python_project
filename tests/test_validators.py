...
from my_python_project.utils.validators import (
    Validator, StringValidator, NumberValidator, ListValidator, DictValidator,
    EmailValidator, URLValidator, DateValidator, JSONValidator, FilePathValidator,
    ChainValidator, ConditionalValidator, TypeValidator,
    validate_input, validate_return, validate_data, create_validator_from_type,
    string_validator, int_validator, email_validator, url_validator
)
...
class TestSpecialValidators:
    ...
    def test_url_validation(self):
        ...
        # 有效URL
        assert validator.validate("https://example.com", "field") == "https://example.com"
        assert validator.validate("http://example.com/path", "field") == "http://example.com/path"
...
class TestUtilityFunctions:
    ...
    def test_validate_data_function(self):
        ...
        schema = {
            "name": StringValidator(),
            "age": NumberValidator(number_type=int)
        }
...
class TestPrebuiltValidators:
    ...
    def test_email_validator(self):
        """测试邮箱验证器"""
        assert email_validator.validate("test@example.com", "field") == "test@example.com"
    
    def test_url_validator(self):
        """测试URL验证器"""
        assert url_validator.validate("https://example.com", "field") == "https://example.com"
