...
from my_python_project import (
    ConfigManager, validate_data, MemoryCache, FileCache,
    cache_result, handle_exceptions, StringValidator, NumberValidator,
    EmailValidator, DictValidator, ValidationError, ConfigError,
    get_project_logger, auto_setup_project_logging
)
        ...
        schema = {
            "database": DictValidator(
                schema={
                    ...
                    "port": NumberValidator(number_type=int, min_value=1, max_value=65535),
...
class TestErrorHandlingIntegration:
    ...
    def test_validation_error_handling(self):
        ...
        @handle_exceptions(ValidationError, default_return={"error": "validation_failed"})
...
class TestPerformanceIntegration:
    ...
    def test_performance_monitoring_integration(self):
        """测试性能监控集成"""
        from my_python_project.utils.performance import monitor_performance, global_monitor
