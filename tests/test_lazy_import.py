...
from my_python_project.utils.lazy_import import (
    LazyImport, LazyModule, lazy_import, conditional_import,
    import_optional, preload_modules, OptionalDependency,
    optional_deps, pandas, numpy, requests
)
...
class TestGlobalOptionalDeps:
    ...
    def test_registered_dependencies(self):
        """测试预注册的依赖"""
        expected_deps = [
            "yaml", "redis", "pandas", "numpy", 
            "requests", "watchdog", "tomli"
        ]
