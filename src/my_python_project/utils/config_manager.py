...
try:
    ...
    HAS_YAML = False
    warnings.warn("PyYAML not installed, YAML support disabled")
...
try:
    ...
    try:
        ...
        HAS_TOML = False
        warnings.warn("tomllib/tomli not installed, TOML support disabled")
    ...
    def get(self, key: str, default: Optional[T] = None, 
        ...
        if type_hint and not isinstance(value, type_hint):
            try:
                ...
                elif type_hint == list and isinstance(value, str):
                    return value.split(',')
